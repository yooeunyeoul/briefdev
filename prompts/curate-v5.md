...
- "AI 에이전트 협업 도구를 직접 만들려는 개발자에게 — Karpathy 스타일 LLM wiki 참고용"
- "브라우저에서 AI를 직접 돌리는 프로토타입을 만드는 개발자에게 — Chrome 확장 통합 예제 제공"
- "LLM 평가/벤치마크에 관심 있는 개발자에게 — 람다 미적분 기반의 새로운 측정 방법 소개"

### 나쁜 예 (피해야 함)
- ❌ "AI 산업의 변화를 이해할 수 있습니다" (너무 추상)
- ❌ "개발자에게 도움이 됩니다" (누구한테 어떤 도움?)
- ❌ "흥미로운 AI 기술입니다" (의견)

### 핵심
- **"누구"를 명시** → 사용자가 자기 케이스인지 즉시 매칭
- 모든 사람이 본인 케이스가 아닐 수 있음을 인정 (정직한 큐레이션)
- 추측 금지 — 본문에서 도출된 구체적 케이스
