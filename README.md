...
**Phase 1 (지금~6개월)**: 무료, 리텐션 검증 우선. **Phase 2 이후**: 개발자 직접 결제 (B2C 구독) 는 의도적 제외 (페르소나 결제 동기 약함). AdSense / 스폰서십 / B2B SaaS 중 베이스라인 데이터 보고 결정. 자세한 내용은 [`ONEPAGER.md`](./ONEPAGER.md).
