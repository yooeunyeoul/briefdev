...
### 실측 결과 (v6, 2026-04-27 기준)
- 풀 크기: **46** (HF 5 + Simon 5 + Verge 5 + Google AI 5 + GeekNews 5 + 토스 5 + 카카오 5 + HN 11, paywall 자동 제외)
- 본문 추출 성공: **18/41** (한국 블로그 일부는 Jina 봇 차단)
- 카드 출력: **5장**
- 출처 분산: **4개 이상 소스에 분포** + 🎯 kr 카테고리 활성화
- LLM 호출: **1회/일** (51초)
